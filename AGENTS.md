...
- `traps.md` ≤ 25 KB → one-off incidents older than 90 days move to `memory/traps/archive-<YYYY>-Q<n>.md`. A trap that names a permanent property of the system is evergreen and stays; when in doubt, keep it.
