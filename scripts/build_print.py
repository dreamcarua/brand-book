...
catalog = [
    ...
    ("colors",       "06",  "Кольори"),
    ("typo",         "07",  "Типографіка"),
    ("spacing",      "08",  "Сітка та елементи"),
    ("components",   "09",  "UI-компоненти"),
    ("motion",       "10",  "Анімації"),
    ("voice",        "11",  "Голос і мова"),
    ("content",      "12",  "Контент"),
    ("crisis",       "13",  "Кризові комунікації"),
    ("partners",     "14",  "Партнери"),
    ("trust",        "15",  "Довіра і доступність"),
    ("tokens",       "16",  "Дизайн-ресурси"),
    ("audio",        "17",  "Стиль медіа"),
    ("touchpoints",  "18",  "Точки контакту"),
    ("merch",        "19",  "Мерч"),
    ("metrics",      "20",  "Стан і roadmap"),
]
