...
NEVER_ROOTS = r'(розігра|лотере[яюї]|\bквит(ок|ка|ки|ків|ку|ком)\b|джекпот|казино|\bбілет|халяв|\bвигра(й|ти|є|в|ла|ли|ш|ємо|єте)\b|\bшанс\b|\bазарт|\bфарт\b|\bставк(а|и|у|ою)\b|переможц|переможни|\bwinners?\b|\bdraw_date\b)'
