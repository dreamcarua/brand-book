...
- ✅ 23.09.2026 закрито агентом (v4.3.2), чекає підтвердження Вадима: хвости v4.3 — службові кольори як декор, сітка кольорів, правило «///», слайди онбордингу, пауза тікера, CSP, шрифти без блокування, CLS, og-image. Вадим 23.09.2026: подвійна шапка — «ні»; Voice Linter API для HQ — «поки ні».
