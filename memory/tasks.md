...
- ⏸ **«500K+ спільнота» не підтверджена даними** — потрібна реальна сума підписників (IG+TG+YT+TikTok) або цифра з `dashboard_ig_account_daily`. Якщо менша — знизити в hero, тікері, trust, онбордингу, humans.txt, og-image, email-шаблоні.
